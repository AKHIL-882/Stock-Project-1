...
// Example removeStock function - Demo
// exports.removeStock = async (req, res) => {
//   const { id } = req.params;

//   try {
//     console.log('Attempting to remove stock with the following details:');
...
//     if (!portfolio) {
//       console.log('No portfolio found with the provided ID and User ID.');
//       return res.status(404).json({ error: 'Stock not found in portfolio' });
//     }

//     await portfolio.destroy();
//     console.log('Stock successfully removed from portfolio');
